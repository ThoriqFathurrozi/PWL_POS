...
class BarangController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($barangs)
            ...
            ->addColumn('aksi', function ($barang) {
                $btn = '<a href="' . url('/barang/' . $barang->barang_id) . '" class="btn btn-info btn-sm mr-2">Detail</a>';
                $btn .= '<a href="' . url('/barang/' . $barang->barang_id . '/edit') . '" class="btn btn-warning btn-sm mr-2">Edit</a>';
    ...
    public function create()
    {
        ...
        return view('barang.create', compact('breadcrumb', 'page', 'kategori', 'activeMenu', 'user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        StokModel::create([
            ...
            'barang_id' => BarangModel::latest()->first()->barang_id,
    ...
    {
        $checkBarang = BarangModel::find($id);
