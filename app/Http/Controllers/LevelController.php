    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($levels)
            ...
            ->addColumn('aksi', function ($level) {
                $btn = '<a href="' . url('/level/' . $level->level_id) . '" class="btn btn-info btn-sm mr-2">Detail</a>';
                $btn .= '<a href="' . url('/level/' . $level->level_id . '/edit') . '" class="btn btn-warning btn-sm mr-2">Edit</a>';
